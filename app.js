    ...
    <head>
      ...
      <style>
        ...
        *{box-sizing:border-box}
        ...
        .drug{padding:2.2mm 2.6mm;border-radius:3.2mm;background:linear-gradient(180deg,#1f5f9e,#183f6a);color:#fff}
        .drug-name{font-size:4.4mm;font-weight:900;line-height:1.15;word-break:break-word}
        .meta-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1.7mm}
        .metric{border:1px solid #dce6f1;border-radius:3mm;padding:1.8mm 2mm;background:#fbfdff;min-height:11.5mm}
        .metric-label{font-size:2.2mm;font-weight:700;color:#67809a;line-height:1.2}
        .metric-value{margin-top:1mm;font-size:3.6mm;font-weight:900;color:#16304f;line-height:1.1}
      ...
      <section class="rx-label">
        <div class="frame">
          ...
          <div class="meta-grid">
            ...
            <div class="metric">
              <div class="metric-label">Dispensed Qty</div>
              <div class="metric-value">${esc(qtyText)}</div>
            </div>
          </div>
          <div class="footer">
