...
function syncUserModalToHiddenFields() {
  ...
  if (cancelBase && cancelModal) cancelBase.classList.toggle('hidden', cancelModal.classList.contains('hidden'));
...
function renderSettings() {
  ...
  if (userField("cancelUserEditBtn")) userField("cancelUserEditBtn").classList.toggle("hidden", !APP.userEditId);
