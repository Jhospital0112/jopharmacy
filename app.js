...
function openPatientHistoryModal() {
  ...
  }).join("") : `<tr><td colspan="8" class="empty-state">No patient history found in the last 30 days.</td></tr>`;
...
q("openShipmentModalBtn").onclick = () => { refreshScopedSelectors(); openModal("shipmentModal"); };
q("openShipmentModalBtn2").onclick = () => { refreshScopedSelectors(); openModal("shipmentModal"); };
q("openTransferModalBtn").onclick = () => { refreshScopedSelectors(); openModal("transferModal"); };
q("openTransferModalBtn2").onclick = () => { refreshScopedSelectors(); openModal("transferModal"); };
