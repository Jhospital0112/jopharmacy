...
document.addEventListener("click", event => {
  ...
  if (roleCard) {
    ...
    const titles = { ADMIN: "Admin Login", IN_PATIENT_USER: "In-Patient Pharmacy Login", OUT_PATIENT_USER: "Out-Patient Pharmacy Login", MEDICAL_CENTER_USER: "Medical Center Pharmacy Login" };
    q("passwordModalTitle").textContent = titles[APP.pendingRole] || "Login";
    q("passwordModalRole").textContent = "Enter employee number and password to continue.";
    q("loginEmployeeNumber").value = "";
