...
document.addEventListener("click", event => {
  ...
  if (latestReturnBtn) return openConfirmActionModal("return", latestReturnBtn.dataset.id);
  ...
  if (latestEditBtn) return openEditPrescription(latestEditBtn.dataset.id);
...
q("closeRecentPrescriptionsBtn").onclick = () => closeModal("recentPrescriptionsModal");
q("viewPatientHistoryBtn").onclick = openPatientHistoryModal;
