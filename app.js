...
async function transferStock() {
  ...
  if (!fromInv || !toInv) {
    showActionModal("Transfer", "Inventory record not found for source or destination.", false);
    q("actionOkBtn").classList.remove("hidden");
    return;
  }
