  ...
  try {
    ...
    if (!fromInv) {
      ...
      operations.push({
        ...
        table: "inventory",
        id: fromInv.id,
        data: { ...fromInv, updatedAt: jordanNowIso() }
      });
    }
    ...
    if (!toInv) {
      ...
      operations.push({
        ...
        table: "inventory",
        id: toInv.id,
        data: { ...toInv, updatedAt: jordanNowIso() }
      });
    }
    ...
    operations.push(
      ...
      },
      {
        ...
        data: {
          ...
          qtyBoxes: boxes,
          qtyUnits: units,
          performedBy: APP.currentRole || "ADMIN",
          note: "Stock transfer",
          dateTime: jordanNowIso()
        }
      }
    ...
    const nextFrom = { ...fromInv, ...updatedFrom };
    const nextTo = { ...toInv, ...updatedTo };
