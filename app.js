...
document.addEventListener("click", event => {
  ...
  if (latestReturnBtn) {
    closeRxActionMenus();
    if (latestReturnBtn.closest("#page-narcotic, #narcoticDepartmentModal, #narcoticRecentModal")) return returnNarcoticPrescription(latestReturnBtn.dataset.id);
  ...
  if (deleteRxBtn) {
    closeAuditMenuPortal();
    closeRxActionMenus();
    if (deleteRxBtn.closest("#page-narcotic, #narcoticDepartmentModal, #narcoticRecentModal")) return deleteNarcoticPrescription(deleteRxBtn.dataset.id);
